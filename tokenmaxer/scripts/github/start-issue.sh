...
Branch creation is handled separately by tokenmaxer/scripts/github/create-issue-branch.sh.
...
main() {
  ...
  echo "Issue #$issue_number started. To create a branch, run: tokenmaxer/scripts/github/create-issue-branch.sh $issue_number"
}
